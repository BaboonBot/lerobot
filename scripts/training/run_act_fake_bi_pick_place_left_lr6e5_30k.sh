...
REPO_ID="NLTuan/act_fake_bi_pick_place_left_lr6e5_30k"
OUTPUT_DIR="outputs/train/act_fake_bi_pick_place_left_lr6e5_30k"
JOB_NAME="act_fake_bi_pick_place_left_lr6e5_30k"
